(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))c(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&c(s)}).observe(document,{childList:!0,subtree:!0});function i(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function c(n){if(n.ep)return;n.ep=!0;const r=i(n);fetch(n.href,r)}})();function b(e){const l=String(e.rawValue??"").split("|")[0];return/^[0-9]$/.test(l)?Number(l)+1:e.syncLevel}const v={arc_suit_fair:"Arc Suit Fair",ex_master_fair:"EX Master Fair",master_fair:"Master Fair",ex_fair:"EX Fair",poke_fair:"Poke Fair",seasonal:"Seasonal",special_costume:"Special Costume",variety:"Variety",spotlight:"Spotlight",trainer_lodge:"Trainer Lodge",battle_points:"Battle Points",ticket_exchange:"Ticket Exchange",gym_scout:"Gym Scout",event_reward:"Event Reward",main_story:"Main Story",legendary_adventures:"Legendary Adventures",general_pool:"General Pool"},a={snapshot:null,challengePairs:[],selectedMemberId:"all",query:"",typeFilter:"all",acquisitionFilters:[],roleFilter:"all",challengeOnly:!1,sortKey:"label",challengeModalOpen:!1,selectedChallengePairIds:[],challengePairQuery:"",selectedChallengeRound:4};function o(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function U(e){const l=(e==null?void 0:e.acquisition)??"";return l?l.includes("Arc Suit Fair")?"arc_suit_fair":l.includes("EX Master Fair")?"ex_master_fair":l.includes("Master Fair")?"master_fair":l.includes("EX Fair")?"ex_fair":l.includes("Poké Fair")||l.includes("Poke Fair")?"poke_fair":l.includes("Seasonal")?"seasonal":l.includes("Special Costume")?"special_costume":l.includes("Variety")?"variety":l.includes("Spotlight")?"spotlight":l.includes("Trainer Lodge")?"trainer_lodge":l.includes("Battle Points")?"battle_points":l.includes("Training Ticket")?"ticket_exchange":l.includes("Gym Scout")?"gym_scout":l.includes("Event Reward")?"event_reward":l.includes("Legendary Adventures")?"legendary_adventures":l.includes("Main Story")?"main_story":"general_pool":"general_pool"}function $(e){return(e==null?void 0:e.acquisitionCategory)||U(e)}function A(e,l,i){const c=!a.query||`${e.label} ${l} ${e.type} ${e.roleLabel} ${e.trainerName} ${e.pokemonName}`.toLowerCase().includes(a.query.toLowerCase()),n=a.typeFilter==="all"||e.type===a.typeFilter,r=a.acquisitionFilters.length===0||a.acquisitionFilters.includes($(e)),s=a.roleFilter==="all"||e.roleCategory===a.roleFilter,d=!a.challengeOnly||i.has(e.pairId);return c&&n&&r&&s&&d}function K(e){const l=a.acquisitionFilters.includes(e);a.acquisitionFilters=l?a.acquisitionFilters.filter(i=>i!==e):[...a.acquisitionFilters,e],m()}function V(e){var c,n;const l=new Set(((c=e.currentChallenge)==null?void 0:c.significantPairIds)??[]);return(a.selectedMemberId==="all"?e.members.flatMap(r=>r.pairs.map(s=>({...s,ownerName:r.displayName}))):(((n=e.members.find(r=>r.id===a.selectedMemberId))==null?void 0:n.pairs)??[]).map(r=>{var s;return{...r,ownerName:((s=e.members.find(d=>d.id===a.selectedMemberId))==null?void 0:s.displayName)??""}})).filter(r=>A(r,r.ownerName,l)).sort((r,s)=>{if(a.sortKey==="owner"){const d=r.ownerName.localeCompare(s.ownerName);return d!==0?d:r.label.localeCompare(s.label)}if(a.sortKey==="type"){const d=(r.type||"").localeCompare(s.type||"");return d!==0?d:r.label.localeCompare(s.label)}if(a.sortKey==="premium"){const d=(v[r.acquisitionCategory]||r.acquisitionCategory).localeCompare(v[s.acquisitionCategory]||s.acquisitionCategory);return d!==0?d:r.label.localeCompare(s.label)}return r.label.localeCompare(s.label)})}function B(e){var i;const l=new Set(((i=e.currentChallenge)==null?void 0:i.significantPairIds)??[]);return e.members.map(c=>{const n=c.pairs.filter(r=>A(r,c.displayName,l)).sort((r,s)=>r.label.localeCompare(s.label));return{memberId:c.id,memberName:c.displayName,pairCount:n.length,pairs:n}}).filter(c=>c.pairCount>0).sort((c,n)=>n.pairCount!==c.pairCount?n.pairCount-c.pairCount:c.memberName.localeCompare(n.memberName))}function X(e){var c;const l=((c=e.currentChallenge)==null?void 0:c.significantPairs)??[],i=new Map;return l.forEach(n=>{const r=i.get(n.pairId);if(!r){i.set(n.pairId,{pairId:n.pairId,label:n.label,categories:new Set(n.category?[n.category]:[]),leaders:new Set(n.leaderName?[n.leaderName]:[])});return}n.category&&r.categories.add(n.category),n.leaderName&&r.leaders.add(n.leaderName)}),Array.from(i.values()).map(n=>({pairId:n.pairId,label:n.label,categories:Array.from(n.categories).sort(),leaders:Array.from(n.leaders).sort()})).sort((n,r)=>n.label.localeCompare(r.label))}function G(e,l,i){if(!e||!l)return"";if(i===1)return e.battle1Effect||"";if(i===2)return e.battle2Effect||"";if(i===3)return e.battle3Effect||"";const c=["modifier1","modifier2","modifier3"].map(s=>{var d;return((d=l.modifiers)==null?void 0:d[s])||""}).filter(Boolean);if(c.length<3)return"";const r=((i-4)%3+e.slotNumber-1)%3;return c[r]||""}function Q(e,l){const i=(e==null?void 0:e.roundStats)??[],c=i.find(r=>r.roundNumber===l);return c||i.filter(r=>r.roundNumber<=l).sort((r,s)=>s.roundNumber-r.roundNumber)[0]||i[i.length-1]||null}function f(e){return Number(e||0).toLocaleString()}function O(e){if(!e)return"";const l=Q(e,a.selectedChallengeRound);return`<section class="challenge-overview-panel">
      ...
      <div class="challenge-leader-grid">
        ${(e.leaders??[]).map(i=>`
              <article class="challenge-leader-card">
                ...
                <p class="challenge-effect">${o(G(i,e,a.selectedChallengeRound)||"No effect configured")}</p>
              </article>`).join("")}
      </div>
    </section>`}function z(e,l){var i;!e||!l||(i=e.querySelector('[data-role="challenge-round-select"]'))==null||i.addEventListener("change",c=>{a.selectedChallengeRound=Number(c.target.value)||4,j()})}function j(){var i;const e=(i=a.snapshot)==null?void 0:i.currentChallenge,l=document.querySelector("#challengeOverviewRoot");!l||!e||(l.innerHTML=O(e),z(l,e))}function D(e){const l=[`${b(e)}/5`],i=String(e.rawValue??"").split("|"),c=Number.parseInt(i[4]??"0",10)>0,n={Strike:"STR",Tech:"TEC",Support:"SUP",Sprint:"SPR",Field:"FLD",Multi:"MLT"};return e.isEx&&l.push("EX"),c&&e.exRoleLabel&&l.push(n[e.exRoleLabel]??e.exRoleLabel.toUpperCase()),l.join(" | ")}function J(e){const l=a.selectedChallengePairIds.includes(e);a.selectedChallengePairIds=l?a.selectedChallengePairIds.filter(i=>i!==e):[...a.selectedChallengePairIds,e],S()}function W(e){a.challengeModalOpen=!0,a.challengePairQuery="",a.selectedChallengePairIds.length||(a.selectedChallengePairIds=a.challengePairs.slice(0,6).map(l=>l.pairId)),m()}function T(){a.challengeModalOpen=!1,m()}function Y(){const e=a.snapshot,l=e==null?void 0:e.currentChallenge;if(!a.challengeModalOpen||!e||!l)return"";const i=a.challengePairQuery.trim().toLowerCase(),c=i?a.challengePairs.filter(s=>`${s.label} ${s.categories.join(" ")} ${s.leaders.join(" ")}`.toLowerCase().includes(i)):a.challengePairs,n=a.challengePairs.filter(s=>a.selectedChallengePairIds.includes(s.pairId)),r=a.selectedChallengePairIds.length?e.members.map(s=>{const d=n.map(h=>{const g=s.pairs.find(u=>u.pairId===h.pairId);return g?{pairId:h.pairId,label:h.label,investment:D({syncLevel:g.syncLevel,isEx:g.isEx,rawValue:g.rawValue,exRoleLabel:g.exRoleLabel})}:null}).filter(Boolean);return{memberId:s.id,memberName:s.displayName,ownedPairs:d}}).filter(s=>s.ownedPairs.length===a.selectedChallengePairIds.length).sort((s,d)=>s.memberName.localeCompare(d.memberName)):[];return`
    ...
    </div>`}function Z(e){var l,i,c;(l=e.querySelector('[data-role="challenge-pair-query"]'))==null||l.addEventListener("input",n=>{a.challengePairQuery=n.target.value,S()}),(i=e.querySelector('[data-role="close-challenge-modal"]'))==null||i.addEventListener("click",()=>{T()}),(c=e.querySelector('[data-role="modal-backdrop"]'))==null||c.addEventListener("click",n=>{var r,s;((s=(r=n.target)==null?void 0:r.dataset)==null?void 0:s.role)==="modal-backdrop"&&T()}),e.querySelectorAll('[data-role="challenge-pair-checkbox"]').forEach(n=>{n.addEventListener("change",()=>{J(n.value)})})}function S(){var s;const e=document.querySelector("#modalRoot");if(!e)return;const l=document.activeElement,i=((s=l==null?void 0:l.dataset)==null?void 0:s.role)??"",c=(l==null?void 0:l.value)??"",n=typeof(l==null?void 0:l.selectionStart)=="number"?l.selectionStart:null,r=typeof(l==null?void 0:l.selectionEnd)=="number"?l.selectionEnd:null;if(e.innerHTML=Y(),Z(e),i&&l instanceof HTMLInputElement&&l.type!=="checkbox"){const d=e.querySelector(`[data-role="${i}"]${c?`[value="${CSS.escape(c)}"]`:""}`);d instanceof HTMLInputElement&&(d.focus(),n!==null&&r!==null&&d.setSelectionRange(n,r))}}function m(){var q,M,N,F,E,x,k,R,_;const e=document.querySelector("#app");if(!e)return;if(!a.snapshot){e.innerHTML='<main class="shell"><section class="panel">Loading roster snapshot...</section></main>';return}const l=a.snapshot,i=V(l),c=l.members,n=Array.from(new Set(l.members.flatMap(t=>t.pairs.map(p=>p.type)).filter(Boolean))).sort(),r=Array.from(new Set(l.members.flatMap(t=>t.pairs.map(p=>p.roleCategory)).filter(Boolean))).sort(),s=l.currentChallenge,d=B(l),h=a.selectedMemberId==="all"&&a.typeFilter!=="all",g=a.selectedMemberId==="all"?`${l.gymName} gym`:((q=c.find(t=>t.id===a.selectedMemberId))==null?void 0:q.displayName)??"Unknown member",u=document.activeElement,C=((M=u==null?void 0:u.dataset)==null?void 0:M.role)??"",w=(u==null?void 0:u.value)??"",P=typeof(u==null?void 0:u.selectionStart)=="number"?u.selectionStart:null,I=typeof(u==null?void 0:u.selectionEnd)=="number"?u.selectionEnd:null,y=document.querySelector("#leftSide"),H=(y==null?void 0:y.scrollTop)??0;e.innerHTML=`
    <main id="main">
      <aside id="leftSide">
        <div id="leftSideHead">
      ...
      <section id="rightSide">
        ...
        ${s?`<div id="challengeOverviewRoot">${O(s)}</div>`:""}
        ...
        ${h?`<div id="memberCoverageSections">
                            ...
                            <div class="member-coverage-grid">
                              ${t.pairs.map(p=>`
                                  <article class="syncPair selected">
                                    ...
                                    <div class="syncLevelBadge">${o(b(p))}</div>
                                    <div class="syncInfos">
                ...
                ${i.length?i.map(t=>`
                          <article class="syncPair selected">
                            ...
                            <div class="syncLevelBadge">${o(b(t))}</div>
                            <div class="syncInfos">
  ...
  `,(N=e.querySelector('[data-role="member-select"]'))==null||N.addEventListener("change",t=>{a.selectedMemberId=t.target.value,m()}),(F=e.querySelector('[data-role="query-input"]'))==null||F.addEventListener("input",t=>{a.query=t.target.value,m()}),(E=e.querySelector('[data-role="type-select"]'))==null||E.addEventListener("change",t=>{a.typeFilter=t.target.value,m()}),e.querySelectorAll('[data-role="acquisition-checkbox"]').forEach(t=>{t.addEventListener("change",()=>{K(t.value)})}),(x=e.querySelector('[data-role="role-select"]'))==null||x.addEventListener("change",t=>{a.roleFilter=t.target.value,m()}),(k=e.querySelector('[data-role="sort-select"]'))==null||k.addEventListener("change",t=>{a.sortKey=t.target.value,m()}),(R=e.querySelector('[data-role="challenge-only"]'))==null||R.addEventListener("change",t=>{a.challengeOnly=t.target.checked,m()}),(_=e.querySelector('[data-role="open-challenge-modal"]'))==null||_.addEventListener("click",()=>{W()}),e.querySelectorAll("[data-member-id]").forEach(t=>{t.addEventListener("click",()=>{a.selectedMemberId=t.dataset.memberId??"all",m()})}),S(),j();const L=e.querySelector("#leftSide");if(L&&(L.scrollTop=H),C&&(u instanceof HTMLInputElement&&u.type!=="checkbox"||u instanceof HTMLSelectElement)){const t=e.querySelector(`[data-role="${C}"]${w?`[value="${CSS.escape(w)}"]`:""}`);(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)&&(t.focus(),t instanceof HTMLInputElement&&P!==null&&I!==null&&t.setSelectionRange(P,I))}}async function ee(){const e=await fetch("./data/rosters.json");a.snapshot=await e.json(),a.challengePairs=X(a.snapshot),m()}ee().catch(e=>{const l=document.querySelector("#app");l&&(l.innerHTML=`<main class="shell"><section class="panel">Failed to load roster snapshot: ${o(e.message)}</section></main>`)});
